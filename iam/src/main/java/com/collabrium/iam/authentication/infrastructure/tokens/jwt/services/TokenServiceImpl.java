package com.collabrium.iam.authentication.infrastructure.tokens.jwt.services;
...
public class TokenServiceImpl implements BearerTokenService {
  ...
  /**
   * Sobrecarga del método privado para incluir roles y user_id.
   */
  private String buildTokenWithClaims(String username, List<String> roles, Long userId) {
